// historial-medico.js - VERSIÓN COMPLETA CORREGIDA
...
// CORRECCIÓN COMPLETA: Cargar información personal del usuario
async function loadPersonalMeasurements() {
  try {
                    ...
                    <div class="profile-form">
                        ...
                        <div class="profile-row">
                            <div class="profile-group">
                                ...
                                <input type="date" id="fechaNacimiento" class="profile-input readonly" value="${userMeasurements.fechaNacimiento.split('T')[0]}" readonly>
                            </div>
                            <div class="profile-group">
    ...
    // CORRECCIÓN: Mejorar el evento de guardar cambios
    ...
    saveButton.addEventListener('click', async (e) => {
      ...
      if (!saveButton.disabled) {
        try {
          ...
          // CORRECCIÓN: Obtener datos correctamente
          ...
          // CORRECCIÓN: Separar apellidos correctamente
          ...
          // CORRECCIÓN: Estructura correcta de datos para el PUT
          const data = {
            nombre: nombre,
          ...
          // CORRECCIÓN: Petición PUT mejorada
          ...
          // CORRECCIÓN: Actualizar datos locales
    ...
    // CORRECCIÓN: Mejorar el evento de editar
    ...
    // CORRECCIÓN: Función para alternar modo de edición
    function toggleEditMode(editMode) {
      ...
      // Si cancelamos la edición, recargar datos originales
      if (!editMode && editButton.textContent === 'Cancelar edición') {
        loadPersonalMeasurements();
      }
    }
    
    // CORRECCIÓN: Toggle de contraseña mejorado
  ...
  modalAlerts.confirm(
    ...
    async () => {
      try {
        ...
        await loadPersonalMeasurementModal(); // Recargar datos
      } catch (error) {
...
// CORRECCIÓN: Función auxiliar para validar fecha
function isValidDate(dateString) {
  const date = new Date(dateString);
  return date instanceof Date && !isNaN(date) && dateString !== '';
}

// CORRECCIÓN: Función auxiliar para formatear nombres
